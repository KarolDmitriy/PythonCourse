...
# 1. принимает параметр желаемое конечное имя файлов. При переименовании в конце имени добавляется порядковый номер.
# 2. принимает параметр количество цифр в порядковом номере.
# 3. принимает параметр расширение исходного файла. Переименование работает только для этих файлов внутри каталога.
# 4. принимает параметр расширение конечного файла.
# 5. принимает диапазон сохраняемого оригинального имени.
